...
/*
 * EDID 1.4 "PicoARC TV" sink profile:
 *   - digital RGB / YCbCr 4:4:4 input using the default sRGB color space
 *   - preferred and only video mode: 1920x1080p60 (148.5 MHz, CTA VIC 16)
 *   - basic audio: 2-channel LPCM at 32/44.1/48 kHz, 16/20/24 bits
 *   - front-left/front-right speakers
 *   - HDMI VSDB source physical address 1.0.0.0
 *   - one CTA-861 revision 3 extension block
 *
 * Not that it matters much for this device, given the fact that it obviously
 * cannot output any video whatsoever, but some sinks reject ARC audio
 * until they get a valid EDID. This does it.
 */
static const uint8_t edid[DDC_EDID_SIZE] = {
    0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x41, 0xd0, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00,
    0x01, 0x24, 0x01, 0x04, 0x80, 0x10, 0x09, 0x78, 0x0e, 0xee, 0x91, 0xa3, 0x54, 0x4c, 0x99, 0x26,
    ...
    0x00, 0x50, 0x49, 0x43, 0x4f, 0x41, 0x52, 0x43, 0x30, 0x30, 0x30, 0x31, 0x0a, 0x20, 0x01, 0x78,
    0x02, 0x03, 0x15, 0x60, 0x23, 0x09, 0x07, 0x07, 0x83, 0x01, 0x00, 0x00, 0x66, 0x03, 0x0c, 0x00,
