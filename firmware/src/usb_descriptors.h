...
// 24-bit packed stereo PCM; alt 3 is IEC 61937 non-PCM passthrough for
// Dolby Digital (AC-3) / DTS over the S/PDIF-style ARC carrier. The active
// rate comes from SET CUR on the clock source (48 kHz or 96 kHz are
// advertised — see usb_audio.c clock_get_request).
#define PICOARC_AUDIO_ALT_ZERO          0
#define PICOARC_AUDIO_ALT_PCM_16        1
#define PICOARC_AUDIO_ALT_PCM_24        2
#define PICOARC_AUDIO_ALT_IEC61937      3
...
#define TUD_AUDIO_PICOARC_DESCRIPTOR(_itfnum, _stridx, _epout, _epfb, _epfbsize, _epint) \
    ...
    TUD_AUDIO_DESC_CS_AS_ISO_EP(AUDIO_CS_AS_ISO_DATA_EP_ATT_NON_MAX_PACKETS_OK, AUDIO_CTRL_NONE, AUDIO_CS_AS_ISO_DATA_EP_LOCK_DELAY_UNIT_MILLISEC, 0x0001),\
    TUD_AUDIO_DESC_STD_AS_ISO_FB_EP(_epfb, _epfbsize, 0x01),\
    /* AS alt 3: IEC 61937 compressed passthrough for DD/DTS on a 16-bit stereo carrier. */ \
