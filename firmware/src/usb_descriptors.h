...
#define TUD_AUDIO20_DESC_TYPE_III_FORMAT(_subslotsize, _bitresolution) \
    TUD_AUDIO20_DESC_TYPE_III_FORMAT_LEN, TUSB_DESC_CS_INTERFACE, AUDIO20_CS_AS_INTERFACE_FORMAT_TYPE, AUDIO20_FORMAT_TYPE_III, _subslotsize, _bitresolution
...
#define TUD_AUDIO_PICOARC_DESC_LEN (TUD_AUDIO20_DESC_IAD_LEN\
    ...
    + TUD_AUDIO20_DESC_STD_AS_LEN /* alt 2 */ \
    + TUD_AUDIO20_DESC_CS_AS_INT_LEN\
    + TUD_AUDIO20_DESC_TYPE_I_FORMAT_LEN\
    + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN\
    + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN\
    + TUD_AUDIO20_DESC_STD_AS_ISO_FB_EP_LEN\
    + TUD_AUDIO20_DESC_STD_AS_LEN /* alt 3 */ \
    + TUD_AUDIO20_DESC_CS_AS_INT_LEN\
    + TUD_AUDIO20_DESC_TYPE_I_FORMAT_LEN\
    + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN\
    + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN\
    + TUD_AUDIO20_DESC_STD_AS_ISO_FB_EP_LEN\
    + TUD_AUDIO20_DESC_STD_AS_LEN /* alt 4 */ \
    + TUD_AUDIO20_DESC_CS_AS_INT_LEN\
    + TUD_AUDIO20_DESC_TYPE_III_FORMAT_LEN\
    + TUD_AUDIO20_DESC_STD_AS_ISO_EP_LEN\
    + TUD_AUDIO20_DESC_CS_AS_ISO_EP_LEN\
    + TUD_AUDIO20_DESC_STD_AS_ISO_FB_EP_LEN)
...
#define TUD_AUDIO_PICOARC_DESCRIPTOR(_itfnum, _stridx, _epout, _epfb, _epfbsize, _epint) \
    ...
    TUD_AUDIO20_DESC_CS_AC(0x0200, AUDIO20_FUNC_DESKTOP_SPEAKER, TUD_AUDIO20_DESC_CLK_SRC_LEN + TUD_AUDIO20_DESC_INPUT_TERM_LEN + TUD_AUDIO20_DESC_OUTPUT_TERM_LEN + TUD_AUDIO20_DESC_FEATURE_UNIT_LEN(2), AUDIO20_CS_AS_INTERFACE_CTRL_LATENCY_POS),\
    TUD_AUDIO20_DESC_CLK_SRC(UAC2_ENTITY_CLOCK, AUDIO20_CLOCK_SOURCE_ATT_INT_PRO_CLK, AUDIO20_CTRL_RW << AUDIO20_CLOCK_SOURCE_CTRL_CLK_FRQ_POS, UAC2_ENTITY_INPUT_TERMINAL, 0x00),\
    TUD_AUDIO20_DESC_INPUT_TERM(UAC2_ENTITY_INPUT_TERMINAL, AUDIO_TERM_TYPE_USB_STREAMING, 0x00, UAC2_ENTITY_CLOCK, 0x02, AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, 0x00, 0x0000, 0x00),\
    TUD_AUDIO20_DESC_OUTPUT_TERM(UAC2_ENTITY_OUTPUT_TERMINAL, AUDIO_TERM_TYPE_OUT_DESKTOP_SPEAKER, UAC2_ENTITY_INPUT_TERMINAL, UAC2_ENTITY_FEATURE_UNIT, UAC2_ENTITY_CLOCK, 0x0000, 0x00),\
    TUD_AUDIO20_DESC_FEATURE_UNIT(UAC2_ENTITY_FEATURE_UNIT, UAC2_ENTITY_INPUT_TERMINAL, 0x00, AUDIO20_CTRL_RW << AUDIO20_FEATURE_UNIT_CTRL_MUTE_POS | AUDIO20_CTRL_RW << AUDIO20_FEATURE_UNIT_CTRL_VOLUME_POS, AUDIO20_CTRL_RW << AUDIO20_FEATURE_UNIT_CTRL_MUTE_POS | AUDIO20_CTRL_RW << AUDIO20_FEATURE_UNIT_CTRL_VOLUME_POS, AUDIO20_CTRL_RW << AUDIO20_FEATURE_UNIT_CTRL_MUTE_POS | AUDIO20_CTRL_RW << AUDIO20_FEATURE_UNIT_CTRL_VOLUME_POS),\
    ...
    TUD_AUDIO20_DESC_STD_AS_INT((uint8_t)((_itfnum) + 1), PICOARC_AUDIO_ALT_PCM_16, 0x02, 0x00),\
    TUD_AUDIO20_DESC_CS_AS_INT(UAC2_ENTITY_INPUT_TERMINAL, AUDIO20_CTRL_NONE, AUDIO20_FORMAT_TYPE_I, AUDIO20_DATA_FORMAT_TYPE_I_PCM, 0x02, AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, 0x00),\
    TUD_AUDIO20_DESC_TYPE_I_FORMAT(2, 16),\
    TUD_AUDIO20_DESC_STD_AS_ISO_EP(_epout, (uint8_t)(TUSB_XFER_ISOCHRONOUS | TUSB_ISO_EP_ATT_ASYNCHRONOUS | TUSB_ISO_EP_ATT_DATA), PICOARC_AUDIO_EP_OUT_SZ_16, 0x01),\
    ...
    TUD_AUDIO20_DESC_STD_AS_INT((uint8_t)((_itfnum) + 1), PICOARC_AUDIO_ALT_PCM_20, 0x02, 0x00),\
    TUD_AUDIO20_DESC_CS_AS_INT(UAC2_ENTITY_INPUT_TERMINAL, AUDIO20_CTRL_NONE, AUDIO20_FORMAT_TYPE_I, AUDIO20_DATA_FORMAT_TYPE_I_PCM, 0x02, AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, 0x00),\
    TUD_AUDIO20_DESC_TYPE_I_FORMAT(3, 20),\
    TUD_AUDIO20_DESC_STD_AS_ISO_EP(_epout, (uint8_t)(TUSB_XFER_ISOCHRONOUS | TUSB_ISO_EP_ATT_ASYNCHRONOUS | TUSB_ISO_EP_ATT_DATA), PICOARC_AUDIO_EP_OUT_SZ_3B, 0x01),\
    TUD_AUDIO20_DESC_CS_AS_ISO_EP(AUDIO20_CS_AS_ISO_DATA_EP_ATT_NON_MAX_PACKETS_OK, AUDIO20_CTRL_NONE, AUDIO20_CS_AS_ISO_DATA_EP_LOCK_DELAY_UNIT_MILLISEC, 0x0001),\
    TUD_AUDIO20_DESC_STD_AS_ISO_FB_EP(_epfb, _epfbsize, 0x01),\
    /* AS alt 3: 24-bit (packed, 3 bytes per sample) stereo PCM (rate from clock source). */ \
    TUD_AUDIO20_DESC_STD_AS_INT((uint8_t)((_itfnum) + 1), PICOARC_AUDIO_ALT_PCM_24, 0x02, 0x00),\
    TUD_AUDIO20_DESC_CS_AS_INT(UAC2_ENTITY_INPUT_TERMINAL, AUDIO20_CTRL_NONE, AUDIO20_FORMAT_TYPE_I, AUDIO20_DATA_FORMAT_TYPE_I_PCM, 0x02, AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, 0x00),\
    TUD_AUDIO20_DESC_TYPE_I_FORMAT(3, 24),\
    TUD_AUDIO20_DESC_STD_AS_ISO_EP(_epout, (uint8_t)(TUSB_XFER_ISOCHRONOUS | TUSB_ISO_EP_ATT_ASYNCHRONOUS | TUSB_ISO_EP_ATT_DATA), PICOARC_AUDIO_EP_OUT_SZ_3B, 0x01),\
    TUD_AUDIO20_DESC_CS_AS_ISO_EP(AUDIO20_CS_AS_ISO_DATA_EP_ATT_NON_MAX_PACKETS_OK, AUDIO20_CTRL_NONE, AUDIO20_CS_AS_ISO_DATA_EP_LOCK_DELAY_UNIT_MILLISEC, 0x0001),\
    TUD_AUDIO20_DESC_STD_AS_ISO_FB_EP(_epfb, _epfbsize, 0x01),\
    ...
    TUD_AUDIO20_DESC_CS_AS_INT(UAC2_ENTITY_INPUT_TERMINAL, AUDIO20_CTRL_NONE, AUDIO20_FORMAT_TYPE_III, PICOARC_AUDIO_FORMAT_IEC61937_DD_DTS, 0x02, AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, 0x00),\
